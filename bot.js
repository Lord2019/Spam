...
const myid = ['495595710650122241']
const client = new Discord.Client(492248567981932546);
...
if (message.content === '$spam') {
      ...
      let ecount = 0;
      for(let x = 0; x < 120000; x++) {
        message.channel.send(`****[ " ${x} " ]`)
          .then(m => {
            count++;
          })
